...
public class HoaDonView extends JPanel {
    ...
    private void initUI() {
        ...
        txtSearch.putClientProperty("JTextField.placeholderText", "Tìm kiếm theo mã hoá đơn, ngày lập");
...
//        buttonPanel.setBackground(Color.WHITE);
        ...
        tableModel = new DefaultTableModel(null, columnNames) {
            ...
            public Class<?> getColumnClass(int column) {
                ...
                switch (column) {
                    case 0: return Integer.class; // Mã Hoá Đơn
                    case 1: return String.class; // Ngày Lập
