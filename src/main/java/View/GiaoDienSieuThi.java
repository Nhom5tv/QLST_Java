...
////        productPanel.setPreferredSize(new Dimension(1000, 800));
////        productPanel.setBorder(BorderFactory.createEmptyBorder(0, 5, 15, 10));
...
////        giaMoi.setFont(new Font("Arial", Font.BOLD, 14));
////
