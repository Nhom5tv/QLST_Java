...
//        buttonPanel.add(btnExportPdf);
        ...
        // ==== Table Setup ====
        String[] columnNames = {"", "Mã Phiếu Nhập", "Tên Nhà Cung Cấp", "Ngày Nhập", "Ghi Chú"};
        ...
        tableChiTiet.setSelectionBackground(new Color(220, 240, 255));
        tableChiTiet.setShowGrid(false);
        tableChiTiet.setIntercellSpacing(new Dimension(2, 2));
        ...
        for (int i = 1; i < tableChiTiet.getColumnCount(); i++) {
            tableChiTiet.getColumnModel().getColumn(i).setCellRenderer(cellRenderer);
        }
        ...
        tableChiTiet.getColumnModel().getColumn(0).setHeaderRenderer((table, value, isSelected, hasFocus, row, column) -> headerCheckBox);
